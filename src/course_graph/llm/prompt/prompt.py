            ...
            examples = [
                {
                    ...
                    "输出":
                        "这段文字介绍了我们一般通过损失函数来评价神经网络的性能, 可以了解到损失函数这一概念。抽取到的实体为\n```json\n{\"知识点\":[\"损失函数\"]}\n```"
                },
                {
                    "输入":
                    ...
                    "输出":
                        "这段文字介绍了神经网络的学习就是参数最优化的过程, 并且通常使用随机梯度下降法来寻找最优参数。抽取到的实体为\n```json\n{\"知识点\": [\"最优化\",\"随机梯度下降法\"]}\n```"
                },
                {
                    "输入":
        ...
        if self.strategy is None:
            examples = [
                ...
                },
                {
                    ...
                    "输出":
                        "这段文字介绍了Numpy的矩阵乘法, 以及使用 np.dot()实现矩阵乘法, 所以应该是先后学习的顺序关系。抽取到的关系为\n```json\n[{\"head\": \"矩阵乘法\", \"relation\": \"顺序\", \"tail\": \"np.dot()\"}]\n```"
                },
                {
                    "输入":
