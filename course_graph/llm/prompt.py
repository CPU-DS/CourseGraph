            ...
            examples = [
                {
                    ...
                    "output":
                        "```这段文字介绍了抑制过拟合的方法之一权值衰减。返回为```json\n[{\"head\": \"过拟合\", \"relation\": \"相关\", \"tail\": \"权值衰减\"}]\n```"
                },
                {
                    "input":
                    ...
                    "output":
                        "这段文字介绍了Numpy的矩阵乘法, 以及使用 np.dot()实现矩阵乘法, 所以应该是先后学习的顺序关系。返回为```json\n[{\"head\": \"矩阵乘法\", \"relation\": \"顺序\", \"tail\": \"np.dot()\"}]\n```"
                },
                {
                    "input":
